...
describe('pokemon', () => {
  it('Debería ser un objeto', () => {
    assert.equal(typeof window.pokemones, 'object');
  });
  
//testeo funcion filterData
 describe('pokemon.filterData', () => {
 it('Debería ser una función', () => {
  assert.equal(typeof window.pokemones.filterData,'function');
 });
...
//testeo funcion sortData
 describe('pokemon.sortData', () => {
  it('Debería ser una función', () => {
    assert.equal(typeof window.pokemones.sortData,'function');
  });
  ...
  it('Debería retornar un arreglo de objetos con los pokemones ordenados por name de forma A-Z', ()   => {
    ...
    assert.deepEqual([orderA_Z[0].name, orderA_Z[1].name, orderA_Z[2].name, orderA_Z[3].name, orderA_Z[4].name],['Abra','Aerodactyl','Alakazam','Arbok','Arcanine']);
  });
 ...
 it('Debería retornar un arreglo de objetos con los pokemones ordenados por name de forma Z-A', ()   => {
    ...
    assert.deepEqual([orderZ_A[0].name, orderZ_A[1].name, orderZ_A[2].name, orderZ_A[3].name],['Zubat','Zapdos','Wigglytuff','Weezing']);
  });
  ...
  it('Debería retornar un arreglo de objetos con los pokemones ordenados por id de big-small', ()   => {
    ...
    assert.deepEqual([numberMayor[0].id, numberMayor[1].id, numberMayor[2].id, numberMayor[3].id],[151,150,149,148]);
  });
  ...
  it('Debería retornar un arreglo de objetos con los pokemones ordenados por id de small-big', ()   => {
    ...
    assert.deepEqual([numberMenor[0].id, numberMenor[1].id, numberMenor[2].id, numberMenor[3].id],[1,2,3,4]);
  });
